...
export const Login: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-bullGray flex flex-col justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex flex-col items-center mb-8">
          ...
          <h1 className="text-2xl sm:text-3xl font-black text-bullDark uppercase tracking-tighter text-center leading-none whitespace-nowrap">
            BULL FITNESS CORE
          </h1>
        ...
        <div className="bg-white py-10 px-6 shadow-2xl rounded-[2.5rem] border border-gray-100 sm:px-10">
          <form className="space-y-6" onSubmit={handleLogin}>
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="block w-full pl-11 pr-4 py-4 bg-bullGray border-none rounded-2xl text-sm font-bold text-bullDark placeholder-gray-400 focus:ring-2 focus:ring-bullRed transition-all"
            ...
            {error && (
              <div className="text-xs font-bold text-bullRed bg-red-50 border border-red-100 rounded-xl p-4 flex items-center gap-3 animate-fade-in-down">
